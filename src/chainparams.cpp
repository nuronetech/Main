...
public:
    CMainParams()
    {
    	...
    	vSeeds.push_back(CDNSSeedData("142.93.196.107", "142.93.196.107"));             // seed1
	vSeeds.push_back(CDNSSeedData("142.93.246.46", "142.93.246.46"));             // seed2
