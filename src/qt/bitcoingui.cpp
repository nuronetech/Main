                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("rTw Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a rTw address"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About rTw Core"), this);
    aboutAction->setStatusTip(tr("Show information about rTw Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for rTw"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your rTw addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified rTw addresses"));
    ...
    showHelpMessageAction->setStatusTip(tr("Show the rTw Core help message to get a list with possible rTw command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("rTw Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to TGT network", "", count));
}
...
{
    QString strTitle = tr("rTw Core"); // default title
