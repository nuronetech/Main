...
void setupAddressWidget(QValidatedLineEdit* widget, QWidget* parent)
{
    ...
    widget->setPlaceholderText(QObject::tr("Enter a rTw address (e.g. %1)").arg("D7VFR83SQbiezrW72hjcWJtcfip5krte2Z"));
#endif
...
{
    return GetSpecialFolderPath(CSIDL_STARTUP) / "rTw.lnk";
}
...
{
    return GetAutostartDir() / "rTw.desktop";
}
